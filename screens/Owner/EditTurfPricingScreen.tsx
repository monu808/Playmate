...
import { updateOwnerTurf } from '../../lib/firebase/owner';
import { resolveTurfPricing } from '../../lib/utils';
import { useAuth } from '../../contexts/AuthContext';

export default function OwnerEditTurfPricingScreen({ navigation, route }: any) {
  const { user } = useAuth();
  ...
  const handleSave = async () => {
    ...
    try {
      setSaving(true);
      const result = await updateOwnerTurf(turfId, user.uid, {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>Configure day and night prices for this turf</Text>
